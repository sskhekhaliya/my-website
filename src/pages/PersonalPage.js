  ...
  return (
    <Carousel>
      ...
      {books.slice(0, 5).map((book, index) => {
        ...
        const imgSrc =
          book.coverUrl ||
          `https://placehold.co/400x600/1f2937/ffffff?text=${encodeURIComponent(book.title)}`;
          ...
          >
            <div className="overflow-hidden rounded-lg">
              <img
                ...
                onError={(e) =>
                  (e.target.src = `https://placehold.co/400x600/1f2937/ffffff?text=${encodeURIComponent(book.title)}`)
                }
      ...
      <div className="space-y-16">
        ...
        <div className="animate-fade-in-up text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            I'm Saurav Singh Khekhaliya — passionate about fitness, technology,
            and writing. This is a living showcase of my journey, thoughts, and
            creative projects.
          </p>
        </div>
        ...
        <div className="animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <p className="mb-6 text-base text-gray-600 dark:text-gray-400 max-w-2xl">
            A collection of my thoughts on technology, self-improvement, and
            philosophical ideas.
          </p>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  A mythological fiction novel that reinterprets ancient tales.
                </p>
              </div>
              <Link
                to="/books/writing"
          ...
          >
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  A venture into the fitness food market with a focus on
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="bg-gray-100 dark:bg-gray-800 text-sm p-2 px-3 rounded-lg text-gray-700 dark:text-gray-300"
                >
                  {skill}
                </span>
              ))}
        ...
        {/* End Note */}
        <div
          className="animate-fade-in-up text-center pt-8"
          style={{ animationDelay: "1s" }}
        >
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Thank you for visiting. This space is constantly evolving, just like
            I am. Let's connect and share our journeys.
          </p>
        </div>
      </div>
    </>
