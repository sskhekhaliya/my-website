    ...
    const handleScroll = () => {
      ...
      if (totalScrollableHeight > 0) {
        const currentProgress =
          (mainEl.scrollTop / totalScrollableHeight) * 100;
      ...
      <div className="bg-white dark:bg-[#232222] text-gray-800 dark:text-gray-200 min-h-screen transition-colors duration-300 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row h-screen">
          <div className="flex flex-col flex-grow h-full overflow-hidden">
            ...
            <main
              ref={mainContentRef}
              className="flex-grow p-6 md:p-10 overflow-y-auto hide-scrollbar pb-24 md:pb-10"
            >
              {children}
            </main>
          </div>
            ...
            <svg className="w-full h-full" viewBox="0 0 44 44">
              ...
              <circle
                ...
                style={{
                  ...
                  transition:
                    "stroke-dashoffset 0.1s linear, opacity 0.3s ease-in-out",
                }}
              />
            </svg>
            <ArrowUp
