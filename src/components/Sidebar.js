    ...
    <aside className="hidden md:flex flex-col items-start justify-between w-64 lg:w-80 p-8 flex-shrink-0">
      ...
      <div className="flex flex-col items-start space-y-6 text-left w-full">
        <nav className="flex flex-col space-y-4">
          <NavLink to="/" className={sidebarNavLinkClasses} end>
            Home
          </NavLink>
          <NavLink to="/blog" className={sidebarNavLinkClasses}>
            Blog
          </NavLink>
          <NavLink to="/about" className={sidebarNavLinkClasses}>
            About
          </NavLink>
          <NavLink to="/contact" className={sidebarNavLinkClasses}>
            Contact
          </NavLink>
        </nav>
