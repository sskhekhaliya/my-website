    ...
    return (
        <div className="animate-fade-in-up space-y-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
            ...
            <div className="relative" ref={dropdownRef}>
                <div className="flex justify-between items-center">
                    ...
                    >
                        <span className="text-sm font-medium">
                            {selectedTags.length === 0 ? 'Filter by Tags' : `${selectedTags.length} tag(s) selected`}
                        </span>
                ...
                <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isDropdownOpen ? 'max-h-60 opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
